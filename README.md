...
[Click here to finish setting up your workspace!](https://cloud.nx.app/connect/Euz5EbJRS1)
...
```sh
npx nx serve nx-remix-react-router
```

To create a production bundle:

```sh
npx nx build nx-remix-react-router
```

To see all available targets to run for a project, run:

```sh
npx nx show project nx-remix-react-router
```
